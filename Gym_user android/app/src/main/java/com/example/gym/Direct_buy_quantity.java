...
public class Direct_buy_quantity extends Activity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_direct_buy_quantity);
...
//                    JR.json_response=(JsonResponse) Direct_buy_quantity.this;
