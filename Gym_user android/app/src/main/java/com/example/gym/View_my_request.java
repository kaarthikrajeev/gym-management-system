...
public class View_my_request extends Activity  implements JsonResponse {

    ListView l1;
    public static String tournament_ids;
    public static String[] tournament_id,name,place,date,time,value,ststuss;
...
//        l1.setOnItemClickListener(this);
        ...
        JR.json_response=(JsonResponse) View_my_request.this;
        String q = "/View_my_request?login_id="+sh.getString("logid","");
        q=q.replace(" ","%20");
        JR.execute(q);
    ...
    public void response(JSONObject jo) {
        ...
        try{
            ...
            if(method.equalsIgnoreCase("View_my_request")){
                ...
                if(status.equalsIgnoreCase("success")){
                    ...
                    for(int i = 0;i<ja1.length();i++)
                    {
                        ...
                        ststuss[i]=ja1.getJSONObject(i).getString("status");
